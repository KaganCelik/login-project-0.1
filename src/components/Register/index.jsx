        ...
        <div className='flex justify-center'>
            <div className='w-[820px] h-[550px] flex m-[5%] bg-[#7ed6df] rounded-full'>
                <div className='gap-5 flex flex-row justify-between'>
                    ...
                    <div>
                        <div className='grid grid-rows-3 gap-2 mt-[40px]'>
                            <h1 className='text-[32px] text-black text-center mb-2 w-[250px]'>Create Account</h1>
                            <input className='p-4 rounded-lg' type="email" placeholder='Username'/>
                            <input className='p-4 rounded-lg' type="email" placeholder='Email'/>
                            <input className='p-4 rounded-lg' type="password" placeholder='Password'/>
                            <p className='text-[12px] mt-1 text-right' href='http://localhost:3000'>Already have an account?
                                <a
